      ...
      if (isset($_POST['selling-submit'])) {
          ...
          if ($mysqli->query($insertQuery)) {
              ...
              if ($productSellType == 'Auctions') {
                  $insertAnchorQuery = "INSERT INTO `auctions` (`Categorie`, `Size`, `Color`, `Starting_Date`, `Finish_Date`, `Price`, `Product_Id` ,`Actual_Bid`)
                                        VALUES ('$productCategory', '$productSize', '$productColor', NOW(), '$productEndDate', '$productPrice', '$productId', '$productPrice')";
